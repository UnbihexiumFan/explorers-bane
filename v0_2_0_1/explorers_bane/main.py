...
tk.update()
a = open("recipes/rec_textures.txt")
rectxt = eval(a.read())
a.close()
...
def generate():
    ...
    c.create_rectangle(90,320,120,350,fill="#aa8800")
    c.create_rectangle(130,320,140,350,fill="#886600")
    c.create_rectangle(150,320,180,350,fill="#444444")
    c.create_rectangle(198,320,208,350,fill="#886600")
    c.create_rectangle(182,320,198,336,fill="#444444")
    c.create_rectangle(228,320,238,350,fill="#886600")
...
def save(event):
    ...
    a.close()
    a = open("save/fallt.txt","w+b")
    a.write(pickle.dumps(world))
    a.close()
    a = open("save/health.txt","w+b")
    a.write(pickle.dumps(world))
    a.close()
    a = open("save/inventory.txt","w+b")
    a.write(pickle.dumps(world))
    a.close()
...
def load(event):
    ...
    a.close()
    a = open("save/fallt.txt","rb")
    b = a.read()
    fallt = pickle.loads(b)
    a.close()
    a = open("save/health.txt","rb")
    b = a.read()
    health = pickle.loads(b)
    a.close()
    a = open("save/inventory.txt","rb")
    b = a.read()
    inventory = pickle.loads(b)
    a.close()
    a = open("save/worldents.txt","rb")
    b = a.read()
